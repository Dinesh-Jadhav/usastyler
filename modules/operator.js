module.exports = {
    ...
    getAllDrivers: async function (searchTerm, sort, from, pageSize) {
        const likeTerm = searchTerm ? "WHERE CONCAT_WS('|',first_name,last_name,certificate_number,mobile_number,car.title,car_plate) LIKE '%" + searchTerm + "%'" : "";
